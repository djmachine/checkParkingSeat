...
class CaptureWindow:
    ...
    def On_Guide(self):
        ...
        self.notebook.add(frame1, text='프로그램 사용법')

        How_Use = tkinter.Label(frame1, text='1. 프로그램 우측 하단에 총 주차량과 현재 주차량을 입력한다.\n2. 입구 출구 구역설정을 실행한다.')
        How_Use.pack()

        frame2 = tkinter.Frame(self.Guide_window)
        self.notebook.add(frame2, text='프로그램 시나리오')

        frame3 = tkinter.Frame(self.Guide_window)
        self.notebook.add(frame3, text='기타 기능')
